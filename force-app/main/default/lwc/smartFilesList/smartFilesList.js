...
export default class SmartFilesList2 extends NavigationMixin(LightningElement) {
    ...
    handleUploadFinished(event) {
        this.smartListShared.displaySuccess(null, this.labels.labelFilesHasBeenUploaded);
    ...
    handleCloseEditFile(event) {
        ...
        if (event.detail.action === 'success') {
            ...
            this.smartListShared.displaySuccess(null, this.labels.labelFile + ' "' + event.detail.fileTitle + '" ' + this.labels.labelWasSaved);
        }
    }
